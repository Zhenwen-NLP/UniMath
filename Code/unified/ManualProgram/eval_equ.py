...
op_dict = {0: 'cal_equal', 1: 'cal_double', 2: 'cal_half', 3: 'cal_add', 4: 'cal_minus',
          5: 'cal_sin', 6: 'cal_cos', 7: 'cal_tan', 8: 'cal_asin', 9: 'cal_acos',
          10: 'g_add', 11: 'g_minus', 12: 'cal_bili',
          13: 'cal_multiply', 14: 'cal_divide', 15: 'cal_area', 16: 'cal_perimeter', 17: 'cal_cone'}
'''
op_dict = {0: 'equal', 1: 'double', 2: 'half', 3: 'add', 4: 'minus',
          5: 'sin', 6: 'cos', 7: 'tan', 8: 'asin', 9: 'acos',
          10: 'g_add', 11: 'g_minus', 12: 'bili',
          13: 'multiply', 14: 'divide', 15: 'area', 16: 'perimeter', 17: 'cone'}
    ...
    def excuate_equation(self, exp, source_nums=None):
        ...
        while idx < len(exp):
            ...
            for tmp in exp[idx + 1: idx + 1 + op_nums]:
                if (tmp[0] == 'N' or tmp[0] == 'n') and int(tmp[-1]) < len(source_nums):
                    excuate_nums.append(source_nums[int(tmp[-1])])
                elif (tmp[0] == 'V' or tmp[0] == 'v') and int(tmp[-1]) < len(vars):
                    excuate_nums.append(vars[int(tmp[-1])])
                elif (tmp[0] == 'C' or tmp[0] == 'c') and int(tmp[-1]) < len(constant):
