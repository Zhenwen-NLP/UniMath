...
def cal_multiply(n1, n2):  # 17
    return n1*n2


def cal_divide(n1, n2):  # 18
    if n1 > 0 and n2 > 0:
        return n1/n2
    return False
