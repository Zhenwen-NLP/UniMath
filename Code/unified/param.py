...
def parse_args(parse=True, **optional_kwargs):
    ...
    parser.add_argument('--seed', type=int, default=10400, help='random seed')
    ...
    parser.add_argument('--feat_dim', type=float, default=1024)
    ...
    parser.add_argument('--n_boxes', type=int, default=49)
    parser.add_argument('--max_n_boxes', type=int, default=49)
    ...
    parser.add_argument('--r_threshold', type=float, default=0.5)
