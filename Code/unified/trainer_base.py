...
class TrainerBase(object):
    ...
    def create_config(self):
        ...
        config = config_class.from_pretrained(self.args.backbone, use_auth_token = False)
        ...
        config.input_dropout_rate = args.input_dropout
        config.hidden_dropout_rate = args.hidden_dropout
